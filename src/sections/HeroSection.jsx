...
export default function HeroSection() {
  ...
  return (
    <Section className="bg-primary text-text relative flex h-screen items-center justify-center overflow-hidden">
      <div className="grid h-full w-full max-w-7xl grid-cols-1 items-center justify-center gap-6 px-5 py-10 md:grid-cols-2">
        {/* lewa kolumna */}
        <div className="flex flex-col items-start justify-center space-y-6 px-5">
          <h1 className="text-accent font-primary text-6xl font-bold tracking-tight uppercase md:text-8xl lg:text-9xl">
            Jadwiga Osial
          </h1>
          <p
        ...
        {/* Prawa kolumna */}
        <div className="flex max-h-full justify-center px-2 md:max-h-4/5 md:px-16 xl:px-24">
          <img
            src={hero1}
            alt="Obraz 1"
            className={`max-w-full rounded-xl border border-neutral-800 object-contain shadow-2xl transition-transform duration-500 hover:scale-105 md:object-cover ${
